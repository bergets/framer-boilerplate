...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.GridComponent = (function(superClass) {
	  ...
	  function GridComponent(options) {
	    ...
	    GridComponent.__super__.constructor.call(this, options);
	  ...
	  GridComponent.prototype._render = function() {
	    ...
	    this._reset();
	    results = [];
	    for (column = i = ref = this.columns - 1; ref <= 0 ? i <= 0 : i >= 0; column = ref <= 0 ? ++i : --i) {
	      results.push((function() {
	        var j, ref1, results1;
	        results1 = [];
	        for (row = j = ref1 = this.rows - 1; ref1 <= 0 ? j <= 0 : j >= 0; row = ref1 <= 0 ? ++j : --j) {
	          frame = {
	            x: this.cellX(column),
	            y: this.cellY(row),
	            width: this.cellWidth,
...
/***/ function(module, exports) {
	...
	exports.date = 1462011588;
	
	exports.branch = "master";
	
	exports.hash = "09e2913-dirty";
